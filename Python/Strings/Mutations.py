# -*- coding: utf-8 -*-
"""
We have seen that lists are mutable (they can be changed), and tuples 
...
The next line contains an integer position, the index location and a 
string character, separated by a space.
